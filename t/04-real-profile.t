...
if (-f "t/fixtures/real-default.b") {
    plan tests => 2;
    system("./export_bookmarks.pl --profile 0 --output /tmp/real-test.b") == 0 or die;
    ...
    plan skip_all => "no real fixture yet — run: perl export_bookmarks.pl --profile 0 --output t/fixtures/real-default.b";
}